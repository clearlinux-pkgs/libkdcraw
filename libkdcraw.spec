...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/libkdcraw-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/libkdcraw-22.12.1.tar.xz.sig
...
%prep
%setup -q -n libkdcraw-22.12.1
cd %{_builddir}/libkdcraw-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673282710
mkdir -p clr-build
pushd clr-build
