...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkdcraw-22.08.0.tar.xz
...
%prep
%setup -q -n libkdcraw-22.08.0
cd %{_builddir}/libkdcraw-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661534208
mkdir -p clr-build
pushd clr-build
