...
Version  : 24.12.1
Release  : 87
URL      : https://download.kde.org/stable/release-service/24.12.1/src/libkdcraw-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/libkdcraw-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/libkdcraw-24.12.1.tar.xz.sig
...
%setup -q -n libkdcraw-24.12.1
cd %{_builddir}/libkdcraw-24.12.1
pushd ..
cp -a libkdcraw-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736484557
mkdir -p clr-build
pushd clr-build
