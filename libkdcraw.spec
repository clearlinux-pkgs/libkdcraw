...
Version  : 18.12.1
Release  : 1
URL      : https://github.com/KDE/libkdcraw/archive/v18.12.1.tar.gz
Source0  : https://github.com/KDE/libkdcraw/archive/v18.12.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548216352
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
