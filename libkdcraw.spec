...
Version  : 25.04.2
Release  : 92
URL      : https://download.kde.org/stable/release-service/25.04.2/src/libkdcraw-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/libkdcraw-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/libkdcraw-25.04.2.tar.xz.sig
...
%setup -q -n libkdcraw-25.04.2
cd %{_builddir}/libkdcraw-25.04.2
pushd ..
cp -a libkdcraw-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749488416
mkdir -p clr-build
pushd clr-build
