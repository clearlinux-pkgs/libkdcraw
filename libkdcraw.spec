...
%prep
%setup -q -n libkdcraw-20.08.2
cd %{_builddir}/libkdcraw-20.08.2
...
cp %{_builddir}/libkdcraw-20.08.2/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkdcraw/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkdcraw-20.08.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkdcraw/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
