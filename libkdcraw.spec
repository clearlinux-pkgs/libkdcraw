...
Version  : 24.08.2
Release  : 84
URL      : https://download.kde.org/stable/release-service/24.08.2/src/libkdcraw-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/libkdcraw-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/libkdcraw-24.08.2.tar.xz.sig
...
%setup -q -n libkdcraw-24.08.2
cd %{_builddir}/libkdcraw-24.08.2
pushd ..
cp -a libkdcraw-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728578223
mkdir -p clr-build
pushd clr-build
