...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/libkdcraw-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/libkdcraw-24.12.3.tar.xz.sig
...
%setup -q -n libkdcraw-24.12.3
cd %{_builddir}/libkdcraw-24.12.3
pushd ..
cp -a libkdcraw-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742429609
mkdir -p clr-build
pushd clr-build
