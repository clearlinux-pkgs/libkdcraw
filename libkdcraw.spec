...
Version  : 22.12.3
Release  : 53
URL      : https://download.kde.org/stable/release-service/22.12.3/src/libkdcraw-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/libkdcraw-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/libkdcraw-22.12.3.tar.xz.sig
...
%prep
%setup -q -n libkdcraw-22.12.3
cd %{_builddir}/libkdcraw-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677778231
mkdir -p clr-build
pushd clr-build
