...
Version  : 24.08.0
Release  : 80
URL      : https://download.kde.org/stable/release-service/24.08.0/src/libkdcraw-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/libkdcraw-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/libkdcraw-24.08.0.tar.xz.sig
...
%setup -q -n libkdcraw-24.08.0
cd %{_builddir}/libkdcraw-24.08.0
pushd ..
cp -a libkdcraw-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724510646
mkdir -p clr-build
pushd clr-build
