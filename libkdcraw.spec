...
Version  : 18.12.2
Release  : 2
URL      : https://github.com/KDE/libkdcraw/archive/v18.12.2.tar.gz
Source0  : https://github.com/KDE/libkdcraw/archive/v18.12.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549647282
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
