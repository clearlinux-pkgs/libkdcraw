...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/libkdcraw-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/libkdcraw-19.12.1.tar.xz.sig
...
%prep
%setup -q -n libkdcraw-19.12.1
cd %{_builddir}/libkdcraw-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578683608
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkdcraw-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/libkdcraw/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/libkdcraw-19.12.1/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkdcraw/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkdcraw-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkdcraw/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
