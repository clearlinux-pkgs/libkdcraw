...
Version  : 23.04.0
Release  : 55
URL      : https://download.kde.org/stable/release-service/23.04.0/src/libkdcraw-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/libkdcraw-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/libkdcraw-23.04.0.tar.xz.sig
...
%prep
%setup -q -n libkdcraw-23.04.0
cd %{_builddir}/libkdcraw-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682014229
mkdir -p clr-build
pushd clr-build
