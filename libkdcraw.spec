...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/libkdcraw-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/libkdcraw-24.12.0.tar.xz.sig
...
%setup -q -n libkdcraw-24.12.0
cd %{_builddir}/libkdcraw-24.12.0
pushd ..
cp -a libkdcraw-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735174315
mkdir -p clr-build
pushd clr-build
...
-DQT_MAJOR_VERSION=6  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
