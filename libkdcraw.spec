...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libkdcraw-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libkdcraw-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libkdcraw-24.02.0
cd %{_builddir}/libkdcraw-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709244160
mkdir -p clr-build
pushd clr-build
