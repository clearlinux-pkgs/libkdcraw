...
Source0  : https://download.kde.org/stable/release-service/22.04.0/src/libkdcraw-22.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.0/src/libkdcraw-22.04.0.tar.xz.sig
...
%prep
%setup -q -n libkdcraw-22.04.0
cd %{_builddir}/libkdcraw-22.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650657673
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkdcraw-22.04.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkdcraw/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkdcraw-22.04.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdcraw/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
