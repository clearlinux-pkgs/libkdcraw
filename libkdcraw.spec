...
Version  : 24.05.1
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.05.1/src/libkdcraw-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/libkdcraw-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/libkdcraw-24.05.1.tar.xz.sig
...
%setup -q -n libkdcraw-24.05.1
cd %{_builddir}/libkdcraw-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718385619
mkdir -p clr-build
pushd clr-build
